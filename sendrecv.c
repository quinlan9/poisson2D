...
//print_coords_tofile(myid,coords);
...
//printf("1\n");
        ...
        exchange3_2d(a, nx, sx, ex,sy,ey, MPI_COMM_WORLD, nbrs[LEFT], nbrs[RIGHT], nbrs[UP], nbrs[DOWN]);
//print_in_order(a,MPI_COMM_WORLD);
        sweep2d(a, f, nx, sx, ex,sy,ey, b);


        exchange3_2d(b, nx, sx, ex, sy, ey, MPI_COMM_WORLD, nbrs[LEFT], nbrs[RIGHT], nbrs[UP], nbrs[DOWN]);
